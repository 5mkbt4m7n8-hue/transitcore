...
assert.equal(api.FIRMWARE_VERSION,"1.0.9");
assert.equal(api.FIRMWARE_FILE,"TransitCore_Universal_BoardClient_v1_0_9.ino");
...
assert.equal(result.filename,"test-board-esp32-v1.0.9.zip");
...
console.log("ESP package builder OK: 4 safe files for Board Client v1.0.9");

...
assert.equal(api.FIRMWARE_VERSION,"1.0.10");
assert.equal(api.FIRMWARE_FILE,"TransitCore_Universal_BoardClient_v1_0_10.ino");
...
assert.equal(result.filename,"test-board-esp32-v1.0.10.zip");

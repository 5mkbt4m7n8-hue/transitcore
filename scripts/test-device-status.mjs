...
for (const firmware of ["1.2.7", "1.2.8", "1.2.9", "1.2.10", "1.2.11", "1.2.12", "1.2.13"]) {
...
const errorClean = cleanStatusPayload({
  ...
  firmware: "1.2.3",
  resetReason: 3,
  lastError: { code: "FEED_RECEIVE", detail: "HTTP status -1", occurredAtUptimeSeconds: 3610, occurrences: 2 }

...
const board = {
  ...
  render: { collisionMode: "unknown-direction", departureAfterglowSeconds: 10, emptyFrameHoldSeconds: 30, freshnessSeconds: 120, arrivalRadiusMeters: 65, terminalArrivalRadiusMeters: 110, atStopConfirmationSeconds: 0, maximumTrackDistanceMeters: 250 },

...
// TransitCore Universal Board Client v1.0.1
// One stable ESP32 engine; board_config.h selects the physical board.
// v1.0.1 adds network diagnostics only; frame and LED behavior are unchanged.
...
void setup() {
  ...
  Serial.println("TransitCore Universal Board Client v1.0.1 starter.");
  Serial.printf(

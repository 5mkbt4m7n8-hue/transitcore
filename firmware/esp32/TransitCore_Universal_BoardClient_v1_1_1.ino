...
// TransitCore Universal Board Client v1.1.1
// One stable ESP32 engine; board_config.h selects the physical board.
// v1.1.1 keeps the LED renderer independent from blocking network requests so
// APPROACHING pulses continue until a newer frame changes the LED state.
...
void setup() {
  ...
  Serial.println("TransitCore Universal Board Client v1.1.1 starter.");
  Serial.printf(

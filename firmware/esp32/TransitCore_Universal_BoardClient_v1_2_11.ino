...
// TransitCore Universal Board Client v1.2.11
...
const char* TRANSITCORE_FIRMWARE_VERSION = "1.2.11";
...
void setup() {
  ...
  Serial.printf("TransitCore Universal Board Client v1.2.11 starter | kompatibel stabil ESP32-S3 LED-driver | hardwareprofil låser LED-datapin | vedvarende feilkø %u/10 | Wi-Fi-reset: hold BOOT i 5 sekunder.\n", deviceErrorQueueCount);
  Serial.printf(

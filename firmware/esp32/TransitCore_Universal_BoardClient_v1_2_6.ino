...
// TransitCore Universal Board Client v1.2.6
...
void setup() {
  ...
  Serial.printf("TransitCore Universal Board Client v1.2.6 starter | retning i LED-logg | vedvarende feilkø %u/10 | Wi-Fi-reset: hold BOOT i 5 sekunder.\n", deviceErrorQueueCount);
  Serial.printf(

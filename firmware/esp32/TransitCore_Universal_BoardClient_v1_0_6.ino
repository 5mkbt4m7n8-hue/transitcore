...
// TransitCore Universal Board Client v1.0.6
// One stable ESP32 engine; board_config.h selects the physical board.
// v1.0.6 sends the first health report as soon as Wi-Fi is ready.
...
void setup() {
  ...
  Serial.println("TransitCore Universal Board Client v1.0.6 starter.");
  Serial.printf(

...
// TransitCore Universal Board Client v1.0.10
// One stable ESP32 engine; board_config.h selects the physical board.
// v1.0.10 verifies TLS with Espressif's maintained public CA bundle and
// supports a unique identity and status credential for each physical device.
...
void setup() {
  ...
  Serial.println("TransitCore Universal Board Client v1.0.10 starter.");
  Serial.printf(

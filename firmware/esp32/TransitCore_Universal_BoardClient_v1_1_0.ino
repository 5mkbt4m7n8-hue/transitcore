...
// TransitCore Universal Board Client v1.1.0
// One stable ESP32 engine; board_config.h selects the physical board.
// v1.1.0 retains verified TLS and unique device credentials, and adds local
// phone-based Wi-Fi provisioning with no cloud handling of Wi-Fi passwords.
...
void setup() {
  ...
  Serial.println("TransitCore Universal Board Client v1.1.0 starter.");
  Serial.printf(

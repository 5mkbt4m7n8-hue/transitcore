...
// TransitCore Universal Board Client v1.0.9
// One stable ESP32 engine; board_config.h selects the physical board.
// v1.0.9 pins physical animation timing to the compiled policy contract.
...
void setup() {
  ...
  Serial.println("TransitCore Universal Board Client v1.0.9 starter.");
  Serial.printf(

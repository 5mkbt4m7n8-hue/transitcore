...
// TransitCore Board Client Gr̴kallbanen v0.3.1
// Dedicated ESP32 client for TransitCore LED feed v1.
// This sketch does not replace or modify the Gr̴kallbanen v0.40.x firmware.
...
void setup() {
  ...
  Serial.println("TransitCore Board Client Gr̴kallbanen v0.3.1 starter.");
  Serial.printf(

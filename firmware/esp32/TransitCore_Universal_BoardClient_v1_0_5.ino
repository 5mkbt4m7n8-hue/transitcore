...
// TransitCore Universal Board Client v1.0.5
// One stable ESP32 engine; board_config.h selects the physical board.
// v1.0.5 adds authenticated remote health reports; LED behavior is unchanged.
...
void setup() {
  ...
  Serial.println("TransitCore Universal Board Client v1.0.5 starter.");
  Serial.printf(

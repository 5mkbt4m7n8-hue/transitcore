...
// TransitCore Universal Board Client v1.2.8
...
const char* TRANSITCORE_FIRMWARE_VERSION = "1.2.8";
...
void setup() {
  ...
  Serial.printf("TransitCore Universal Board Client v1.2.8 starter | synlig LED-datapin | LED-vakthund og strømretur | vedvarende feilkø %u/10 | Wi-Fi-reset: hold BOOT i 5 sekunder.\n", deviceErrorQueueCount);
  Serial.printf(
